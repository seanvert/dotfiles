...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(restclient zenburn-theme yasnippet-snippets writeroom-mode which-key websocket web-mode use-package undo-tree try tree-mode tide spaceline solarized-theme smartparens skewer-mode rainbow-delimiters prettier-js polymode pdfgrep pdf-view-restore pandoc-mode pandoc ox-reveal ox-jekyll-md ox-epub org-roam-bibtex org-ref org-pretty-tags org-pomodoro org-plus-contrib org-noter org-journal org-drill org-download org-bullets ob-sml nov multi-term mode-icons memoize magit lsp-ui lsp-python lsp-haskell lsp-clangd linum-relative leetcode keycast julia-mode json-mode intero indium html-to-markdown howdoyou helm-swoop helm-org-rifle helm-lsp helm-dash helm-cider helm-c-yasnippet haskell-snippets god-mode gif-screencast frames-only-mode flycheck-pycheckers flycheck-plantuml flycheck-package flycheck-irony flycheck-haskell flycheck-demjsonlint flycheck-cython flycheck-clojure flycheck-cask ewal-spacemacs-themes ess-smart-underscore emmet-mode eink-theme edit-server django-mode deft deferred dap-mode cyberpunk-theme company-quickhelp company-org-roam company-math company-lsp company-irony company-ghci company-box company-auctex company-anaconda auto-yasnippet auto-org-md auto-complete auto-compile anki-editor))))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
