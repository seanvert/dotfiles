...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(pdf-view-restore org-pomodoro god-mode cyberpunk-theme mode-icons company-irony dash-functional lsp-haskell emmet-mode edit-server cider yasnippet-classic-snippets writeroom-mode which-key use-package undo-tree try smartparens rainbow-delimiters projectile pandoc-mode pandoc ox-reveal ox-jekyll-md ox-epub org-ref org-pretty-tags org-plus-contrib org-noter org-journal org-drill org-download org-bullets ob-sml nyan-mode nov magit linum-relative leetcode keycast html-to-markdown howdoyou helm-dash haskell-snippets gif-screencast flycheck-pycheckers flycheck-plantuml flycheck-irony flycheck-haskell flycheck-cask ess-smart-underscore company-math auto-org-md auto-compile all-the-icons)))
